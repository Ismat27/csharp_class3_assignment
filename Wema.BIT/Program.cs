    ...
    public class User
    {
        public static void Main(string[] args)
        {
            ...
            List <Users> users = new List<Users>()
            {
                ...
                new Users() {Id =2, FirstName="Jim", LastName="Johnson", Email="johnson@email.com", Transactions=transaction.Where(x => x.UserId == 2).ToList()},

                new Users() {Id =3, FirstName="Mike", LastName="Johnson", Email="johnson@email.com", Transactions=transaction.Where(x => x.UserId == 3).ToList()},

                new Users() {Id =4, FirstName="Jide", LastName="Johnson", Email="johnson@email.com", Transactions=transaction.Where(x => x.UserId == 4).ToList()},

                new Users() {Id =5, FirstName="Tomi", LastName="Johnson", Email="johnson@email.com", Transactions=transaction.Where(x => x.UserId == 5).ToList()},
